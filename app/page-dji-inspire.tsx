...
function DroneModel({ droneRef }: { droneRef: React.RefObject<THREE.Group> }) {
  ...
  return (
    <group ref={droneRef}>
      {/* Professionelle DJI Inspire Drohne */}
      <primitive
        object={scene.clone()}
        scale={[1, 1, 1]}
        position={[0, 0, 0]}
      ...
      {/* Zusätzliche rotierende Rotoren für bessere Sichtbarkeit */}
      <group ref={(el) => (rotorRefs.current[0] = el)} position={[0.5, 0.2, 0.5]}>
        <Cylinder args={[0.08, 0.08, 0.04]} position={[0, 0, 0]}>
          <meshStandardMaterial color="#1a1a1a" />
        </Cylinder>
        <Box args={[0.3, 0.004, 0.08]} position={[0, 0.006, 0]}>
          <meshStandardMaterial color="#333333" transparent opacity={0.9} />
        </Box>
        <Box args={[0.3, 0.004, 0.08]} position={[0, 0.006, 0]} rotation={[0, Math.PI / 2, 0]}>
          <meshStandardMaterial color="#333333" transparent opacity={0.9} />
        </Box>
      </group>
      
      <group ref={(el) => (rotorRefs.current[1] = el)} position={[-0.5, 0.2, 0.5]}>
        <Cylinder args={[0.08, 0.08, 0.04]} position={[0, 0, 0]}>
          <meshStandardMaterial color="#1a1a1a" />
        </Cylinder>
        <Box args={[0.3, 0.004, 0.08]} position={[0, 0.006, 0]}>
      ...
      <group ref={(el) => (rotorRefs.current[2] = el)} position={[0.5, 0.2, -0.5]}>
        <Cylinder args={[0.08, 0.08, 0.04]} position={[0, 0, 0]}>
          <meshStandardMaterial color="#1a1a1a" />
        </Cylinder>
        <Box args={[0.3, 0.004, 0.08]} position={[0, 0.006, 0]}>
      ...
      <group ref={(el) => (rotorRefs.current[3] = el)} position={[-0.5, 0.2, -0.5]}>
        <Cylinder args={[0.08, 0.08, 0.04]} position={[0, 0, 0]}>
          <meshStandardMaterial color="#1a1a1a" />
        </Cylinder>
        <Box args={[0.3, 0.004, 0.08]} position={[0, 0.006, 0]}>
...
export default function DJIInspirePage() {
  return (
